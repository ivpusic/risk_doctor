...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Car.num_of_drivers'
        db.add_column('risk_management_site_car', 'num_of_drivers',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Car.num_of_drivers'
        db.delete_column('risk_management_site_car', 'num_of_drivers')
